...
router.put('/breeders/profile', authentication.isLoggedIn, breederUserController.updateProfile);
...
router.get('/users/profile', authentication.isLoggedIn, userController.profile);
router.put('/users/profile', authentication.isLoggedIn, userController.updateProfile);
